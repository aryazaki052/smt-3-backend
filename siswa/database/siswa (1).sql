...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2023 at 10:10 AM
...
CREATE TABLE `admin_user` (
  ...
  `usname_admin` varchar(100) NOT NULL,
  `pass_admin` int(100) NOT NULL
...
INSERT INTO `admin_user` (`id_admin`, `usname_admin`, `pass_admin`) VALUES
(11, 'arya_zaki', 12345678),
(12, 'admin', 12345678);
...
INSERT INTO `dosen` (`npk`, `nama_dosen`, `email_dosen`, `no_hp_dosen`) VALUES
(101, 'hoki', 'ghjkl@gmail.com', '084567123'),
(123, 'nyoman', 'abc@gmail.com', '0814567'),
(456, 'gusti', 'asdfg@gmail.com', '0845672423'),
(789, 'arya', 'fghj@gmail.com', '08456234');
...
INSERT INTO `jadwal_kuliah` (`id_jadwal`, `hari`, `jam_mulai`, `jam_selesai`, `kode_kelas`, `kode_mk`, `npk`, `id_ruang`) VALUES
(1, 'senin', '09:40:00', '13:00:00', 221, 'SK001', 101, 1),
(2, 'senin', '08:00:00', '11:20:00', 221, 'SK002', 456, 2),
(3, 'selasa', '08:00:00', '11:20:00', 221, 'SK003', 123, 2),
(4, 'rabu', '11:20:00', '13:00:00', 221, 'SK005', 789, 8),
(5, 'kamis', '08:00:00', '11:20:00', 221, 'SK008', 123, 5);
...
('10', 'S1 - SISTEM KOMPUTER'),
('11', 'S1 - Sistem Informasi'),
('12', 'S1 - Teknologi Informasi'),
('13', 'S1 - Bisnis Digital'),
('14', 'D3 - Manajamen Informatika');
...
INSERT INTO `krs_mahasiswa` (`id_krs`, `NIM`, `nama`, `kode_mk`) VALUES
(30, 220113001, 'komang lazuardi', 'SK001'),
(31, 220113001, 'komang lazuardi', 'SK002'),
(32, 220113001, 'komang lazuardi', 'SK003'),
(33, 220113001, 'komang lazuardi', 'SK005'),
(34, 220113001, 'komang lazuardi', 'SK008'),
(36, 220010001, 'arya zaki', 'SK001'),
(37, 220010001, 'arya zaki', 'SK002'),
(38, 220010001, 'arya zaki', 'SK003'),
(39, 220010001, 'arya zaki', 'SK005'),
(40, 220010001, 'arya zaki', 'SK008');
...
INSERT INTO `login_mhs` (`id_mhs`, `NIM`, `pass_mhs`) VALUES
(21, 220010001, '12345678'),
(22, 220113001, '111');
...
('SK001', 'Dasar Infrastuktur Teknologi', 2, 1),
('SK002', 'Algoritma dan Pemograman', 4, 1),
('SK003', 'Praktikum Algortima dan Pemograman', 2, 1),
('SK004', 'Bahasa Asing 1', 4, 1),
('SK005', 'Agama', 2, 1),
('SK006', 'Front End Web Development', 4, 2),
('SK007', 'Bahasa Asing 2', 4, 2),
('SK008', 'Basis Data', 2, 2),
('SK009', 'Praktikum Basis Data', 2, 2),
('SK010', 'Organisi Komputer', 2, 2);
...
INSERT INTO `pendaftaran` (`NIM`, `nama`, `nik`, `tempat_lahir`, `tanggal_lahir`, `jk`, `kewarganegaraan`, `agama`, `nama_ibu`, `email`, `no_telp`, `alamat`, `kode_pos`, `provinsi`, `kabupaten`, `kecamatan`, `pendidikan`, `sekolah`, `nilai_raport`, `prog1`, `kelas`) VALUES
(220010001, 'arya zaki', '5271062008040001', 'denpasar', '2023-11-01', 1, 'WNI', 'Kristen', 'haha', 'yogaarya020@gmail.com', '082359365098', 'dsdds23', '2323', 21, 2103, 210307, 'SMA-IPA', 'sman 1 mataram', 77, '10', 'Reguler'),
(220113001, 'komang lazuardi', '5271062008040001', 'denpasar', '2023-11-09', 1, 'WNI', 'Hindu', 'haha', 'yogaarya020@gmail.com', '000', 'dsdds23', '2323', 19, 1904, 190403, 'SMA-IPA', 'sman 1 mataram', 23, '13', 'Karyawan');
...
CREATE TABLE `pengumuman` (
  ...
  `judul_pengumuman` varchar(300) NOT NULL,
  `deskripsi` varchar(200) NOT NULL,
  `tgl_post` date NOT NULL,
  `dokumen` varchar(291) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `pengumuman` (`id_pengumuman`, `judul_pengumuman`, `deskripsi`, `tgl_post`, `dokumen`) VALUES
(14, 'ini coba pengumuman kedua', 'berisi informasi mengenai sdfghjmda', '2023-11-15', '22924-1-44772-1-10-20160802.doc'),
(15, 'in pengumuman', 'ini deskripsi', '2023-11-16', 'unggah/394-File Utama Naskah-636-1-10-20160615.pdf'),
(16, 'pengumuman', 'ini deskripsi ketiga', '2023-11-16', '418313586-KEL-4-PENJADWALAN-PROSES-SISTEM-OPERASI-docx.docx');
...
INSERT INTO `ruang_kelas` (`id_ruang`, `nama_ruangan`) VALUES
(1, '1.1'),
(2, '1.2'),
(3, '1.3'),
(4, '2.1'),
...
ALTER TABLE `jadwal_kuliah`
  ...
  ADD KEY `fk_kode_mk` (`kode_mk`),
  ADD KEY `fk_id_ruangan` (`id_ruang`),
  ADD KEY `fk_npk` (`npk`);
...
--
ALTER TABLE `jadwal_kuliah`
  MODIFY `id_jadwal` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `krs_mahasiswa`
--
ALTER TABLE `krs_mahasiswa`
  MODIFY `id_krs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `jadwal_kuliah`
  ADD CONSTRAINT `fk_id_ruangan` FOREIGN KEY (`id_ruang`) REFERENCES `ruang_kelas` (`id_ruang`),
  ADD CONSTRAINT `fk_kode_mk` FOREIGN KEY (`kode_mk`) REFERENCES `matakuliah` (`kode_mk`),
  ADD CONSTRAINT `fk_npk` FOREIGN KEY (`npk`) REFERENCES `dosen` (`npk`);

--
-- Constraints for table `krs_mahasiswa`
--
ALTER TABLE `krs_mahasiswa`
  ADD CONSTRAINT `kode_mk_fk` FOREIGN KEY (`kode_mk`) REFERENCES `matakuliah` (`kode_mk`),
  ADD CONSTRAINT `krs_mahasiswa_ibfk_1` FOREIGN KEY (`NIM`) REFERENCES `pendaftaran` (`NIM`);
COMMIT;
