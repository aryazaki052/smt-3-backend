...
<div>
	...
	// Query SELECT untuk menampilkan data admin
...
<div>
  ...
  $hasil_pengumuman = mysqli_query($kon, $pengumuman);
  ?>
</div>
<!-- end kode php pengumuman -->
<!-- header -->
<div class="wrapper">
            ...
            <div class="col-md-12">
              <div class="card full-height">
                ...
                <div class="card-head-row">
                  ...
                  <a href="create.php" class="btn btn-primary btn-sm ml-auto">Tambah Pengumuman</a>
                </div>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      <?php
                      while ($data = mysqli_fetch_assoc($hasil_pengumuman)) {
