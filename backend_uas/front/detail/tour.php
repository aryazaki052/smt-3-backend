...
<head>
  ...
  <title>Explore the beauty of Bali with best Bali Tour packages</title>
...
<body>
  <nav class="navbar container-fluid navbar-expand-md navbar-light navbar-transparent ">
    <div class="container-fluid">
      <!-- Logo navbar -->
      <a class="navbar-brand logo" href="landingpage.html"><img src="../gambar/logonew.png" alt="logo"
          width="105px"></a>
      ...
      <div class="container-lg collapse navbar-collapse justify-content-end navbara" id="navbarNavDropdown">
        <ul class="navbar-nav navbarb">
          <li class="nav-item">
            <a class="nav-link" href="../landingpage/landingpage.html">Home</a>
          </li>
          <li class="nav-item">
  ...
  <!-- carousel item -->
  <div class="carousel">
    <img src="../gambar/pic tour 1.jpg" alt="Gambar 1" class="active">
    <img src="../gambar/pic tour 3.jpeg" alt="Gambar 2">
