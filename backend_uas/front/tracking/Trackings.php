      ...
      <div class="container-lg collapse navbar-collapse justify-content-end navbara" id="navbarNavDropdown">
        <ul class="navbar-nav navbarb">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="">Bali Tracking</a>
          </li>
          <li class="nav-item">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card">
                <div class="ratio ratio-16x9 img-hover-zoom">
                    <img src="../../backview/assets/uploads/tracking/<?php echo $data['gambar_gunung']; ?>">
                </div>
                <div class="card-body">
                  ...
                  <p class="card-text">
                      ...
                      $truncatedOverview = (strlen($overview) > 150) ? substr($overview, 0, 150) . '...' : $overview;
                      echo $truncatedOverview;
                      ?>
                  </p>
                  <a href="tracking.php?id=<?php echo $data['id']; ?>" class="btn btn-primary">Visit Now!</a>
