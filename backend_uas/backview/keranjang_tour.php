...
<body>
  ...
  <div>
    ...
    $qry_tracking = mysqli_query($con->con, 'SELECT keranjang_tour.*, tour.nama_gunung, guide.nama_guide FROM keranjang_tour
    LEFT JOIN tour ON keranjang_tour.id_tour = tour.id_tour
    LEFT JOIN guide ON keranjang_tour.id_guide = guide.id_guide');
                ...
                <div class="card-header">
                  <div class="card-head-row" style="justify-content: space-between;">
                    ...
                    <div class="d-flex mx-5" style="gap: 20px;">
                      <a href="dashboard.php" class="btn btn-sm ml-auto "> Tracking</a>
                      <a href="" class="btn btn-sm ml-auto actives">Tour</a>
