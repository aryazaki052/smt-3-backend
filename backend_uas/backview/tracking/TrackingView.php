            ...
            <div class="col-md-12">
              <div class="card full-height">
                ...
                <div class="card-head-row">
						<div class="card-title">Data Tracking</div>
            <a href="trackingcreate.php" class="btn btn-primary btn-sm ml-auto">Tambah</a>
					</div>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
									<table class="table table-bordered">
										...
										<tbody>
												...
												// include('../../class/back/DBClass.php');
												// $con = new database;
												$qry = mysqli_query($con->con, 'SELECT * FROM tracking');
												while ($data = mysqli_fetch_assoc($qry)) {
														echo "<tr>";
														echo "<td>" . $data['nama_gunung'] . "</td>";
														echo "<td>" . $data['overview'] . "</td>";
														echo "<td>" . $data['act_highlight'] . "</td>";
														echo "<td>" . $data['price'] . "</td>";
														echo "<td><img src='../assets/uploads/tracking/" . $data['gambar_gunung'] . "' alt='Gambar Gunung' style='width: 50px; height: 50px;'></td>"; // Tampilkan gambar
														echo "<td class='text-center'>
																		<a href='trackingedit.php?id=" . $data['id'] . "'><i class='fa fa-pencil primary' aria-hidden='true'></i></a> 
																		<a href='delete.php?id=" . $data['id'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\"><i class='fa fa-trash ml-2 text-danger' aria-hidden='true'></i></a>
																	</td>";
														echo "</tr>";
												}
												?>
