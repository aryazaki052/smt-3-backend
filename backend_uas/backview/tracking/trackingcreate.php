                    ...
                    <div class="card-body">
                        <form action="create.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="overview" id="editorOverview" class="form-control" placeholder="Berikan Deskripsi Singkat"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="body">Activity Highlight</label>
                                <textarea name="act_highlight" id="editorActivity" class="form-control" placeholder="Berikan Deskripsi Singkat"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="body">Include</label>
                                <textarea name="include" id="editorInclude" class="form-control" placeholder="Include"></textarea>
                            </div>
