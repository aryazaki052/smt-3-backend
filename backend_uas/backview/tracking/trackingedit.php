...
$qry = mysqli_query($con->con, "SELECT * FROM tracking WHERE id = $id_tracking");
            ...
            <div class="col-md-12">
                <div class="card full-height">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="id"  value="<?= $data_sebelumnya['id'] ?>" class="form-control" id="text"  readonly hidden>
                    </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <textarea name="overview" id="editorOverview" class="form-control" placeholder="Berikan Deskripsi Singkat"><?= $data_sebelumnya['overview'] ?? ''; ?></textarea>
                      </div>
                      <div class="form-group">
                          <label for="body">Activity Highlight</label>
                          <textarea name="act_highlight" id="editorActivity" class="form-control" placeholder="Berikan Deskripsi Singkat"><?= $data_sebelumnya['act_highlight'] ?? ''; ?></textarea>
                      </div>
                      <div class="form-group">
                          <label for="body">Include</label>
                          <textarea name="include" id="editorInclude" class="form-control" placeholder="Include"><?= $data_sebelumnya['include'] ?? ''; ?></textarea>
                      </div>
                      <div class="form-group" id="gambarFormGroup">
                          <label for="gambar">Harga</label>
                          <input type="number" name="harga" class="form-control" placeholder="Harga" value="<?= $data_sebelumnya['price'] ?? ''; ?>">
                      </div>
                      <div class="form-group" id="gambarFormGroup">
                          ...
                          <br>
                          <img src="<?= isset($data_sebelumnya['gambar_gunung']) ? '../assets/uploads/tracking/' . $data_sebelumnya['gambar_gunung'] : ''; ?>" alt="Gambar Saat Ini" style="width: 100px;">
