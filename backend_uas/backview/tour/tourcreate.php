                    ...
                    <div class="card-body">
                        <form action="create.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="highlight" id="editorHighlight" class="form-control" placeholder="Berikan Deskripsi Singkat"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="body">Things to do</label>
                                <textarea name="things" id="editorthings" class="form-control" placeholder="Berikan Deskripsi Singkat"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="body">Itinerary</label>
                                <textarea name="itinerary" id="editorItinerary" class="form-control" placeholder="Berikan Deskripsi Singkat"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="body">Inclusions</label>
                                <textarea name="inclusions" id="editorInclude" class="form-control" placeholder="Berikan Deskripsi Singkat"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="body">Exclusions</label>
                                <textarea name="exclusions" id="editorExclude" class="form-control" placeholder="Berikan Deskripsi Singkat"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="body">What to brings</label>
                                <textarea name="brings" id="editorBrings" class="form-control" placeholder="Berikan Deskripsi Singkat"></textarea>
                            </div>
