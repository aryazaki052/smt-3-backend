              ...
              <div class="card full-height">
                <div class="card-header">
                  <div class="card-head-row">
                    ...
                    <a href="GuideView.php" class="btn btn-primary btn-sm ml-auto btn-warning">Back</a>
                  </div>
                </div>
                <div class="card-body">
                  <form action="create.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      while ($row_guide = mysqli_fetch_assoc($qry)) {
                          echo "<option value='" . $row_guide['id_guide'] . "'>" . $row_guide['nama_guide'] . "</option>";
                      }                      
                       ?>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <?php
                      $qry = mysqli_query($con->con, 'SELECT * FROM kategori');
                      while ($row_guide = mysqli_fetch_assoc($qry)) {
                          echo "<option value='" . $row_guide['id_kategori'] . "'>" . $row_guide['nama_kategori'] . "</option>";
                      }
                       ?>
                      </select>
                    </div>
