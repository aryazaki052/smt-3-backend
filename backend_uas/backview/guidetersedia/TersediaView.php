              ...
              <div class="card full-height">
                <div class="card-header">
                  <div class="card-head-row" style="justify-content: space-between;">
                    <div class="card-title">Jadwal Guide</div>
                    <div class="">
                      <!-- <a href="trackingcreate.php" class="btn btn-primary btn-sm ml-auto"> Tracking</a>
                      <a href="trackingcreate.php" class="btn btn-primary btn-sm ml-auto">Tour</a>
                      <a href="trackingcreate.php" class="btn btn-primary btn-sm ml-auto">Driver</a> -->
                      <a href="tersediacreate.php" class="btn btn-primary btn-sm ml-auto">Tambah</a>
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="?category=0">Semua Kategori</a></li>
                      <li><a class="dropdown-item" href="?category=1">Bali Tracking</a></li>
                      <li><a class="dropdown-item" href="?category=2">Bali Tour</a></li>
                      <li><a class="dropdown-item" href="?category=3">Bali Transport</a></li>
                    </ul>
                  </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                        // Bangun query
                        $query = "SELECT j.id_jadwal, g.nama_guide, k.nama_kategori, j.tangal 
                                  FROM jadwal_guide j
                                  JOIN guide g ON j.id_guide = g.id_guide
                                  JOIN kategori k ON j.id_kategori = k.id_kategori";

                        if ($categoryFilter > 0) {
                          $query .= " WHERE k.id_kategori = $categoryFilter";
                        }

                        $qry = mysqli_query($con->con, $query);
                        while ($data = mysqli_fetch_assoc($qry)) {
                          echo "<tr>";
                          echo "<td>" . $data['id_jadwal'] . "</td>";
                          echo "<td>" . $data['nama_guide'] . "</td>";
                          echo "<td>" . $data['nama_kategori'] . "</td>";
                          echo "<td>" . $data['tangal'] . "</td>";
                          // Tambahkan tombol atau link untuk aksi lainnya sesuai kebutuhan
                          echo "<td class='text-center'>     
                                <a href='tersediaedit.php?id=" . $data['id_jadwal'] . "'><i class='fa fa-pencil primary' aria-hidden='true'></i></a>                    					
                                <a href='delete.php?id=" . $data['id_jadwal'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\">
