              ...
              <div class="card full-height">
                <div class="card-header">
                  <div class="card-head-row" style="justify-content: space-between;">
                    <div class="card-title">Data Guide</div>
                    <div class="">
                      ...
                      <a href="guidecreate.php" class="btn btn-primary btn-sm ml-auto">Tambah</a>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                        $qry = mysqli_query($con->con, 'SELECT * FROM guide');
                        while ($data = mysqli_fetch_assoc($qry)) {
                          echo "<tr>";
                          echo "<td>" . $data['id_guide'] . "</td>";
                          echo "<td>" . $data['nama_guide'] . "</td>";
                          echo "<td>" . $data['deskripsi'] . "</td>";
                          echo "<td><img src='../assets/uploads/guide/" . $data['gambar_guide'] . "' alt='Gambar Gunung' style='width: 50px; height: 50px;'></td>"; // Tampilkan gambar
                          echo "<td  d class='text-center'>                        					
                        						<a href='delete.php?id=" . $data['id_guide'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\"><i class='fa fa-trash ml-2 text-danger' aria-hidden='true'></i></a>
                        					</td>";
                          echo "</tr>";
                        }
                        ?>
