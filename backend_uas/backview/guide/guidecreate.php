                ...
                <div class="card-body">
                  <form action="create.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="deskripsi" id="editorOverview" class="form-control" placeholder="Berikan Deskripsi Singkat"></textarea>
                    </div>
                    <div class="form-group" id="gambarFormGroup">
                      <label for="gambar">Foto Guide</label>
                      <input type="file" name="gambar_guide" class="form-control">
                    </div>
                    <div class="form-group">
