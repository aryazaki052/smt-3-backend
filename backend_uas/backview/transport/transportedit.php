...
<body>
	...
	<div>
		...
		$qry = mysqli_query($con->con, "SELECT * FROM transport WHERE id_trans = $id_trans");
								...
								<div class="card-body">
									<form action="edit.php" method="POST" enctype="multipart/form-data">
										<div class="form-group">
											...
											<input type="text" name="id" value="<?= $data_sebelumnya['id_trans'] ?>" class="form-control" id="text" readonly hidden>
										</div>
										<div class="form-group">
											<label for="judul">Nama Transport</label>
											<input type="text" name="nama" class="form-control" id="text" placeholder="Masukan Judul" value="<?= $data_sebelumnya['nama_mobil'] ?? ''; ?>">
										</div>
										<div class="form-group">
											...
											<select name="kategori" id="kategori">
												...
												while ($row = mysqli_fetch_assoc($query_kategori)) {
													...
													// Cek apakah kategori saat ini adalah yang dipilih sebelumnya
													$selected = ($id_kategori == $data_sebelumnya['id_kategori']) ? 'selected' : '';
										...
										<div class="form-group">
											...
											<textarea name="highlight" id="editorOverview" class="form-control" placeholder="Berikan Deskripsi Singkat"><?= $data_sebelumnya['highlight'] ?? ''; ?></textarea>
										</div>
										<div class="form-group">
											<label for="body">Harga</label>
											<textarea name="price" id="editorActivity" class="form-control" placeholder="Berikan Deskripsi Singkat"><?= $data_sebelumnya['price'] ?? ''; ?></textarea>
										</div>
										<div class="form-group">
											<label for="body">Harga 2</label>
											<textarea name="price_2" id="editorInclude" class="form-control" placeholder="Include"><?= $data_sebelumnya['price_2'] ?? ''; ?></textarea>
										</div>
										<div class="form-group" id="gambarFormGroup">
											<label for="gambar">Harga 3</label>
											<input type="number" name="price_3" class="form-control" placeholder="Harga" value="<?= $data_sebelumnya['price_3'] ?? ''; ?>">
										</div>
										<div class="form-group" id="gambarFormGroup">
											...
											<br>
											<img src="<?= isset($data_sebelumnya['gambar_mobil']) ? '../assets/uploads/transport/' . $data_sebelumnya['gambar_mobil'] : ''; ?>" alt="Gambar Saat Ini" style="width: 100px;">
