							...
							<div class="card full-height">
								<div class="card-header">
									<div class="card-head-row">
										...
										<a href="transportcreate.php" class="btn btn-primary btn-sm ml-auto">Tambah</a>
									</div>
								</div>
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-bordered">
											...
											<tbody>
												<?php
												$qry = mysqli_query($con->con, 'SELECT transport.*, kategori_trans.nama_kategori
                                FROM transport
                                JOIN kategori_trans ON transport.id_kategori = kategori_trans.id_kategori');
												while ($data = mysqli_fetch_assoc($qry)) {
													echo "<tr>";
													echo "<td>" . $data['nama_mobil'] . "</td>";
													echo "<td>" . $data['Transmisi'] . "</td>";
													echo "<td>" . $data['nama_kategori'] . "</td>"; // Menampilkan nama kategori
													echo "<td>" . $data['highlight'] . "</td>";
													echo "<td>" . $data['price'] . "</td>";
													echo "<td>" . $data['price_2'] . "</td>";
													echo "<td>" . $data['price_3'] . "</td>";
													echo "<td><img src='../assets/uploads/transport/" . $data['gambar_mobil'] . "' alt='Gambar Mobil' style='width: 50px; height: 50px;'></td>";
													echo "<td class='text-center'>
														<a href='transportedit.php?id=" . $data['id_trans'] . "'><i class='fa fa-pencil primary' aria-hidden='true'></i></a> 
														<a href='delete.php?id=" . $data['id_trans'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\"><i class='fa fa-trash ml-2 text-danger' aria-hidden='true'></i></a>
													</td>";
													echo "</tr>";
												}
												?>
