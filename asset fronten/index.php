  ...
  <div class="row">
    <div class="col-md-6 col-sm-12">
      <div class="isi">
        <ul>
          <h1>KHS</h1>
          <h2>Kerohanian Hindu <br />Smansa</h2>
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Expedita
            quaerat debitis dolore, ea id quisquam vitae quod, voluptatibus
            placeat nisi neque rem natus, fuga corporis libero dolor
            consequuntur laudantium quae?
          </p>
        </ul>
      </div>
      <div class="logospan">
        <div>
          <img src="gambar/logohd.png" width="265px" alt="" />
