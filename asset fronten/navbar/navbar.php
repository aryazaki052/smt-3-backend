...
<body>
  <nav class="navbar container-fluid navbar-expand-md navbar-light ">
    <div class="container-fluid">
      <!-- Logo navbar -->
      <a class="navbar-brand" style="margin-left: 80px;" href="#"><img src="gambar/logo.png" alt="logo"
          width="105px"></a>
      ...
      <div class="container-lg collapse navbar-collapse justify-content-end navbara" id="navbarNavDropdown">
        <ul class="navbar-nav navbarb">
          ...
          <li>
            <a href="tracking.html">Bali Tracking</a>
          </li>
          <li>
            <a href="tracking.html">Bali Jeep Tour</a>
          </li>
          <li>
