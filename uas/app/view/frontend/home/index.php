  ...
  <div class="carousel">
    ...
    <img src="<?= BASEURL; ?>/img/2.jpg" alt=" 2" />
    <img src="<?= BASEURL; ?>/img/3.jpg" alt=" 3" />
  ...
  <div class="container-xl kartu">
    ...
    <div class="row kartu2" style="text-align: center">
      <div class="col-md kartu1 link1">
        ...
        <img src="<?= BASEURL; ?>/img/kartu1.jpg" alt="" width="100%" />
      </div>
      ...
      <div class="col-md kartu1 link3">
        ...
        <!-- <h5>Chose & Find Your Spirit</h5> -->
        <img src="<?= BASEURL; ?>/img/kartu3.jpg" alt="" width="100%" />
      </div>
    </div>
  </div>
