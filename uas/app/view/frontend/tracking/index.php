        ...
        <div class="owl-carousel owl-theme">
          <div class="item mb-4">
            <div class="card border-0 shadow">
              <img src="<?=BASEURL; ?>/img/card1.jpg" alt="" class="card-img-top">
            </div>
          </div>

          <div class="item">
            <div class="card border-0 shadow">
              <img src="<?=BASEURL; ?>/img/card2.jpg" alt="" class="card-img-top">
            </div>
          </div>
          ...
          <div class="item">
            <div class="card border-0 shadow">
              <img src="<?=BASEURL; ?>/img/card3.jpg" alt="" class="card-img-top">
            </div>
          </div>

          <div class="item">
            <div class="card border-0 shadow">
              <img src="<?=BASEURL; ?>/img/card4.jpg" alt="" class="card-img-top">
            </div>
          </div>

          <div class="item">
            <div class="card border-0 shadow">
              <img src="<?=BASEURL; ?>/img/card5.jpg" alt="" class="card-img-top">
            </div>
          </div>

          <div class="item">
            <div class="card border-0 shadow">
              <img src="<?=BASEURL; ?>/img/card6.jpg" alt="" class="card-img-top">
            </div>
          </div>

          <div class="item">
            <div class="card border-0 shadow">
              <img src="<?=BASEURL; ?>/img/card7.jpg" alt="" class="card-img-top">
            </div>
          </div>
