<link rel="stylesheet" href="<?= BASEURL; ?>/front/tour/tour.css" />

  <!-- carousel item -->
  <div class="carousel">
    <img src="<?=BASEURL; ?>/img/2.jpg" alt="Gambar 1" class="active">
    <img src="<?=BASEURL; ?>/img/3.jpg" alt="Gambar 2">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text"> that we recommend for those of you who like interesting and unique places to visit in
              Bali.</p>
            <a href="<?=BASEURL; ?>/detailtour" class="btn btn-primary">Visit Now!</a>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card">
          <div class="ratio ratio-16x9 img-hover-zoom">
            <img src="<?=BASEURL; ?>/img/lagon2.jpg">
          </div>
          <div class="card-body">
